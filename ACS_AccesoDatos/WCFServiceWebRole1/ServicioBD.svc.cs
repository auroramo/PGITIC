...
namespace WCFServiceWebRole1
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Server=tcp:52.232.83.25\SQLEXPRESS,1433;Database=Sensores;User ID=sa;Password=pass;Trusted_Connection=False;Encrypt=False;Connection Timeout=30");
